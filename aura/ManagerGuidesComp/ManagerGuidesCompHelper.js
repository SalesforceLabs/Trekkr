({
    next : function(comp) {
        ...
        if(position == 'YOURBUDDIES')
            ...
            newPosition = 'ASSIGNPROGRAMS';
                ...
                else if(position == 'YOURMENTORS')
                    newPosition= 'YOURBUDDIES';
        comp.set('v.page',newPosition);
    },
    previous : function(comp){
        var position = comp.get('v.page');
        var newPosition;
        if(position == 'PROFILE_INFORMATION')
            ...
            newPosition = 'PROFILE_INFORMATION';
                ...
                newPosition = 'ASSIGNPROGRAMS';
                else if(position == 'YOURBUDDIES')
                    newPosition = 'YOURMENTORS';
        comp.set('v.page',newPosition);
    },
    ...
    getMentorsMenteesInformation : function(component,event,onCallback){
        var action = component.get("c.getMentorMenteeDetails");
        action.setCallback(this, onCallback);
        $A.enqueueAction(action);
    },
